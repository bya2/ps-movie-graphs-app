...
const fn_service__movies__now_playing = require("../../service/movies/now_playing");
// const fn_service__movies__latest = require("../../service/movies/latest");
const fn_service__movies__upcoming = require("../../service/movies/upcoming");
// const fn_service__movies__popular = require("../../service/movies/popular");
const fn_service__movie__detail = require("../../service/movie/index");
...
router.get("/now_playing", async (req, res) => {
  ...
  const movies__arr = await fn_service__movies__now_playing();

  let results__arr = [];

  const promises__arr = await Promise.all(
    movies__arr(async (movie__obj) => {
  ...
  for (const promise of promises__arr) {
